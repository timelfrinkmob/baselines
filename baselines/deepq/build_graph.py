...
def build_act(make_obs_ph, q_func, num_actions, scope="deepq", reuse=None, noisy = False, bootstrap=False):
...
`       See the top of the file for details.
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        if bootstrap:
            _act = U.function(inputs=[observations_ph, head, stochastic_ph, update_eps_ph],
...
def build_train(make_obs_ph, q_func, num_actions, optimizer, grad_norm_clipping=None, gamma=1.0,
    double_q=True, scope="deepq", reuse=None, param_noise=False, param_noise_filter_func=None, noisy = False, bootstrap=False):
